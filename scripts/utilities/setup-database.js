...
async function setupDatabase() {
  console.log('🚀 Setting up SK Program Management System database...')
  ...
  try {
    ...
    // Create database
    await connection.query('CREATE DATABASE IF NOT EXISTS sk_project')
    ...
    await dbConnection.query(`
      CREATE TABLE IF NOT EXISTS forms (
        ...
        gcash_receipt BOOLEAN DEFAULT FALSE,
    ...
    // Create junction tables after all main tables exist
    await dbConnection.query(`
    ...
    `)
    console.log('✅ Program assignments table created')
    ...
    `)
    console.log('✅ Event assignments table created')
...
async function seedDatabase() {
  try {
    ...
    console.log('✅ Event assignments created')
